              ...
              {books.length > 0 ? (
                books.map((book) => (
                  <tr key={book._id || book.id}>
                    ...
                    <td className="px-3 py-2 whitespace-nowrap text-sm">{book.isbn}</td>
                    <td className="px-3 py-2 whitespace-nowrap text-sm">{book.copies}</td>
                  </tr>
                ))
              ) : (
                <tr>
                  <td colSpan="4" className="px-3 py-2 text-center text-sm">
                    {loading ? 'Loading books...' : 'No books found. Click Refresh to load books.'}
                  </td>
                </tr>
              )}
            </tbody>

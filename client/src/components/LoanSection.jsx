      ...
      <div className="mt-6">
        ...
        <div className="mt-4">
          ...
          {loans.length > 0 ? (
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {loans.map((loan) => (
                    <tr key={loan._id || loan.id}>
                      <td className="px-3 py-2 whitespace-nowrap text-sm">{loan.book_id}</td>
                      ...
                      <td className="px-3 py-2 whitespace-nowrap text-sm">
                        {!loan.returned && (
                          <button
                            onClick={() => handleReturnBook(loan._id || loan.id)}
            ...
            <p className="text-gray-500 italic">No loans found for this user.</p>
          )}
        </div>
      </div>
    </div>
